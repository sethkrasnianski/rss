defmodule RssWeb.UserAuthTest do
  use RssWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Rss.Accounts
  alias RssWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, RssWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      RssWeb.Endpoint.subscribe(live_socket_id)
